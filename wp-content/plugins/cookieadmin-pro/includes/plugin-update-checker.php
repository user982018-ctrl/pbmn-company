...
class CookieAdminUpdateChecker_3_2 {
	 ...
	 * @param CookieAdminUpdate_3_2 $updateToAdd
	 * @return StdClass
	 */
	 ...
	 * successfully, the first argument passed will be an instance of  CookieAdminInfo. Otherwise, 
	 * it will be NULL. The second argument will be the corresponding return value of 
	 * wp_remote_get (see WP docs for details).
	 *  
	 * The callback function should return a new or modified instance of CookieAdminInfo or NULL.
	 * 
	 * @uses add_filter() This method is a convenience wrapper for add_filter().
	 * 
	 * @param callable $callback
	...
	public function initDebugBarPanel() {
		...
		if ( class_exists('Debug_Bar', false) && file_exists($debugBarPlugin) ) {
			...
			$this->debugBarPlugin = new CookieAdmin_PucDebugBarPlugin_3_2($this);
		}
	}
...
if ( !class_exists('CookieAdminInfo_3_2', false) ):
...
class CookieAdminInfo_3_2 {
	...
	/**
	 * Create a new instance of CookieAdminInfo from JSON-encoded plugin info 
	 * returned by an external update API.
	 * 
	 * @param string $json Valid JSON string representing plugin info.
	 * @return CookieAdminInfo_3_2|null New instance of CookieAdminInfo, or NULL on error.
	 */
...
if ( !class_exists('CookieAdminUpdate_3_2', false) ):
...
class CookieAdminUpdate_3_2 {
	...
	/**
	 * Create a new instance of CookieAdminUpdate from its JSON-encoded representation.
	 * 
	 * @param string $json
	 * @return CookieAdminUpdate_3_2|null
	 */
	public static function fromJson($json){
		...
		$pluginInfo = CookieAdminInfo_3_2::fromJson($json);
		if ( $pluginInfo != null ) {
			return self::fromCookieAdminInfo($pluginInfo);
		} else {
			return null;
		}
	}
	...
	/**
	 * Create a new instance of CookieAdminUpdate based on an instance of CookieAdminInfo.
	 * Basically, this just copies a subset of fields from one object to another.
	 * 
	 * @param CookieAdminInfo_3_2 $info
	 * @return CookieAdminUpdate_3_2
	 */
	public static function fromCookieAdminInfo($info){
		return self::fromObject($info);
	}
	
	/**
	 * Create a new instance of CookieAdminUpdate by copying the necessary fields from 
	 * another object.
	 *  
	 * @param StdClass|CookieAdminInfo_3_2|CookieAdminUpdate_3_2 $object The source object.
	 * @return CookieAdminUpdate_3_2 The new copy.
	 */
	 ...
	 * a CookieAdminUpdate. Useful for serialization and caching, as it avoids
...
if ( !class_exists('CookieAdmin_PucScheduler_3_2', false) ):

/**
 * The scheduler decides when and how often to check for updates.
 * It calls @see CookieAdminUpdateChecker::checkForUpdates() to perform the actual checks.
 *
 * @version 3.2
 */
class CookieAdmin_PucScheduler_3_2 {
	public $checkPeriod = 12; //How often to check for updates (in hours).
	public $throttleRedundantChecks = false; //Check less often if we already know that an update is available.
	public $throttledCheckPeriod = 72;

	/**
	 * @var CookieAdminUpdateChecker_3_2
	 */
	 ...
	 *
	 * @param CookieAdminUpdateChecker_3_2 $updateChecker
...
if ( !class_exists('CookieAdmin_PucUpgraderStatus_3_2', false) ):
 ...
 */
class CookieAdmin_PucUpgraderStatus_3_2 {
...
if ( !class_exists('CookieAdmin_PucFactory', false) ):

/**
 * A factory that builds instances of other classes from this library.
 *
 * When multiple versions of the same class have been loaded (e.g. CookieAdminUpdateChecker 1.2
 * and 1.3), this factory will always use the latest available version. Register class
 * versions by calling {@link CookieAdmin_PucFactory::addVersion()}.
 *
 * At the moment it can only build instances of the CookieAdminUpdateChecker class. Other classes
 * are intended mainly for internal use and refer directly to specific implementations. If you
 * want to instantiate one of them anyway, you can use {@link CookieAdmin_PucFactory::getLatestClassVersion()}
 * to get the class name and then create it with <code>new $class(...)</code>.
 */
class CookieAdmin_PucFactory {
	protected static $classVersions = array();
	protected static $sorted = false;

	/**
	 * Create a new instance of CookieAdminUpdateChecker.
	 *
	 * @see CookieAdminUpdateChecker::__construct()
	 *
	 * @param $metadataUrl
	 * @param $pluginFile
	 * @param string $slug
	 ...
	 *
	 * @param string $generalClass Class name without version numbers, e.g. 'CookieAdminUpdateChecker'.
...
CookieAdmin_PucFactory::addVersion('CookieAdminUpdateChecker', 'CookieAdminUpdateChecker_3_2', '3.2');
CookieAdmin_PucFactory::addVersion('CookieAdminUpdate', 'CookieAdminUpdate_3_2', '3.2');
CookieAdmin_PucFactory::addVersion('CookieAdminInfo', 'CookieAdminInfo_3_2', '3.2');
CookieAdmin_PucFactory::addVersion('CookieAdmin_PucGitHubChecker', 'CookieAdmin_PucGitHubChecker_3_2', '3.2');
