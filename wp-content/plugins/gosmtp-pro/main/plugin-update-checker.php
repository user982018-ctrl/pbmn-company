...
if ( !class_exists('GosmtpUpdateChecker_3_2', false) ):
...
class GosmtpUpdateChecker_3_2 {
	...
	public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
		...
		$this->upgraderStatus = new Gosmtp_PucUpgraderStatus_3_2();
	...
	protected function createScheduler($checkPeriod) {
		return new Gosmtp_PucScheduler_3_2($this, $checkPeriod);
	}
	...
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($status) ){
			$pluginInfo = GosmtpInfo_3_2::fromJson($result['body']);
			if ( $pluginInfo !== null ) {
	 ...
	 * @param GosmtpUpdate_3_2 $updateToAdd
	 * @return StdClass
	 */
...
if ( !class_exists('GosmtpInfo_3_2', false) ):
...
if ( !class_exists('GosmtpUpdate_3_2', false) ):
...
class GosmtpUpdate_3_2 {
	...
	public static function fromJson($json){
		...
		if ( $pluginInfo != null ) {
			return self::fromGosmtpInfo($pluginInfo);
		} else {
			return null;
		}
	}
	 ...
	 * a GosmtpUpdate. Useful for serialization and caching, as it avoids
...
if ( !class_exists('Gosmtp_PucScheduler_3_2', false) ):
...
if ( !class_exists('Gosmtp_PucUpgraderStatus_3_2', false) ):
...
if ( !class_exists('Gosmtp_PucFactory', false) ):
